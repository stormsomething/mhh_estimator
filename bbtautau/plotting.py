...
def k_lambda_comparison_plot(mhh_HH_01, mhh_HH_10, fold_1_array_1, fold_1_array_10, label, mvis_1, mvis_10):
    ...
    if label == 'mmc':
        mhh_HH_01 = mhh_HH_01 / mvis_1
        mhh_HH_10 = mhh_HH_10 / mvis_10
...
def resid_comparison_plots(mus, sigmas, old_preds, mmc_preds, fold_1_array, label, mvis):
    truths = fold_1_array['universal_true_mhh'] / mvis
    weights = fold_1_array['EventInfo___NominalAuxDyn']['evtweight'] * fold_1_array['fold_weight']
    mmc_preds = mmc_preds / mvis

    indices_1 = np.where(sigmas < 0.15)
    indices_2 = np.where((sigmas > 0.15) & (sigmas < 0.25))
    indices_3 = np.where((sigmas > 0.25) & (sigmas < 0.35))
    indices_4 = np.where(sigmas > 0.35)
    ...
    plt.hist(
        ...
        range=(-1.5,1.5),
        histtype='step',
        label=r'$\sigma(m_{HH})<0.15$, DNN. Mean: ' + str(round(old_mean_1, 4)) + '. RMS: ' + str(round(old_rms_1, 4)),
        density=True)
    plt.hist(
        old_data[indices_2],
        bins=100,
        ...
        range=(-1.5,1.5),
        histtype='step',
        label=r'$0.15<\sigma(m_{HH})<0.25$, DNN. Mean: ' + str(round(old_mean_2, 4)) + '. RMS: ' + str(round(old_rms_2, 4)),
        density=True)
    plt.hist(
        old_data[indices_3],
        bins=100,
        ...
        range=(-1.5,1.5),
        histtype='step',
        label=r'$0.25<\sigma(m_{HH})<0.35$, DNN. Mean: ' + str(round(old_mean_3, 4)) + '. RMS: ' + str(round(old_rms_3, 4)),
        density=True)
    plt.hist(
        old_data[indices_4],
        bins=100,
        ...
        range=(-1.5,1.5),
        histtype='step',
        label=r'$\sigma(m_{HH})>0.35$, DNN. Mean: ' + str(round(old_mean_4, 4)) + '. RMS: ' + str(round(old_rms_4, 4)),
        density=True)
    plt.xlim((-1.5,1.5))
    plt.xlabel(r'$m_{HH}/m_{vis}$ Residual')
    plt.ylabel('Events')
    ...
    plt.hist(
        ...
        range=(-1.5,1.5),
        histtype='step',
        label=r'$\sigma(m_{HH})<0.15$, MMC. Mean: ' + str(round(mmc_mean_1, 4)) + '. RMS: ' + str(round(mmc_rms_1, 4)),
        density=True)
    plt.hist(
        mmc_data[indices_2],
        bins=100,
        ...
        range=(-1.5,1.5),
        histtype='step',
        label=r'$0.15<\sigma(m_{HH})<0.25$, MMC. Mean: ' + str(round(mmc_mean_2, 4)) + '. RMS: ' + str(round(mmc_rms_2, 4)),
        density=True)
    plt.hist(
        mmc_data[indices_3],
        bins=100,
        ...
        range=(-1.5,1.5),
        histtype='step',
        label=r'$0.25<\sigma(m_{HH})<0.35$, MMC. Mean: ' + str(round(mmc_mean_3, 4)) + '. RMS: ' + str(round(mmc_rms_3, 4)),
        density=True)
    plt.hist(
        mmc_data[indices_4],
        bins=100,
        ...
        range=(-1.5,1.5),
        histtype='step',
        label=r'$\sigma(m_{HH})>0.35$, MMC. Mean: ' + str(round(mmc_mean_4, 4)) + '. RMS: ' + str(round(mmc_rms_4, 4)),
        density=True)
    plt.xlim((-1.5,1.5))
    plt.xlabel(r'$m_{HH}/m_{vis}$ Residual')
    plt.ylabel('Events')
    ...
    plt.hist(
        ...
        range=(0,3),
        histtype='step',
        label=r'$\sigma(m_{HH})<0.15$. Mean: ' + str(round(mean_1, 4)) + '. RMS: ' + str(round(rms_1, 4)),
        density=True)
    plt.hist(
        mus[indices_2],
        bins=100,
        ...
        range=(0,3),
        histtype='step',
        label=r'$0.15<\sigma(m_{HH})<0.25$. Mean: ' + str(round(mean_2, 4)) + '. RMS: ' + str(round(rms_2, 4)),
        density=True)
    plt.hist(
        mus[indices_3],
        bins=100,
        ...
        range=(0,3),
        histtype='step',
        label=r'$0.25<\sigma(m_{HH})<0.35$. Mean: ' + str(round(mean_3, 4)) + '. RMS: ' + str(round(rms_3, 4)),
        density=True)
    plt.hist(
        mus[indices_4],
        bins=100,
        ...
        range=(0,3),
        histtype='step',
        label=r'$\sigma(m_{HH})>0.35$. Mean: ' + str(round(mean_4, 4)) + '. RMS: ' + str(round(rms_4, 4)),
        density=True)
    plt.xlim((0,3))
    plt.xlabel(r'$m_{HH}/m_{vis}$')
    plt.ylabel('Events')
...
def sigma_plots(mus, sigmas, fold_1_array, label, mvis):
    ...
    # This creates such a large file I would not advise doing this
    """
    fig = plt.figure()
    plt.scatter(
        sigmas,
        ...
        s=5)
    plt.xlabel(r'$\sigma(m_{HH}/m_{vis})$')
    plt.ylabel(r'$m_{HH}/m_{vis}$ Residual')
    fig.savefig('plots/mdn_resid_sigma_scatter_' + label + '.pdf')
    plt.close(fig)
    """
...
def rnn_mmc_comparison(predictions_rnn, test_target, ak_array, ak_array_fold_1_array, label, regressor, mvis, predictions_old = None, predictions_mmc = None):
