...
def keras_model_main(n_variables):
    ...
    hidden = Dense(2048, activation='relu')(x_1)
    hidden_1 = Dense(1024, activation='relu')(hidden)
    ...
    hidden_7 = Dense(16, activation='relu')(hidden_6)
    hidden_8 = Dense(8, activation='relu')(hidden_7)
    output1 = Dense(1, activation='linear')(hidden_8)
    output2 = Dense(1, activation='linear')(hidden_8)
    return Model(inputs=x_1, outputs=[output1, output2])
    
def keras_model_funnel_2048_2_output(n_variables):
    x_1 = Input(shape=n_variables)
    hidden = Dense(2048, activation='relu')(x_1)
    hidden_1 = Dense(1024, activation='relu')(hidden)
    hidden_2 = Dense(512, activation='relu')(hidden_1)
